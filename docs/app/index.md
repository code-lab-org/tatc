...
The web applicaton for TAT-C has been moved to its own repository: [TAT-C Web App](https://github.com/code-lab-org/tatc-app)

The optional web application is built on top of TAT-C to expose
